...
export const CITY_PAGES: Record<string, CityPageContent> = {
  praiagrande: {
    ...
    description:
      "Criação de sites profissionais em Praia Grande com SEO técnico, performance e foco em geração de contatos para empresas locais.",
    heading: "Criação de Sites em Praia Grande com SEO Local",
    intro:
      "Desenvolvemos sites profissionais para negocios de Praia Grande que querem aparecer no Google e converter visitantes em clientes reais.",
  ...
  santos: {
    ...
    description:
      "Agência de desenvolvimento web em Santos. Criamos sites premium com SEO técnico, UX e alta performance para negócios locais.",
  ...
  cubatao: {
    ...
    description:
      "Desenvolvimento de sites em Cubatão para indústrias, comércio e serviços com SEO técnico e desempenho de alto nível.",
  ...
  guaruja: {
    ...
    description:
      "Criação de sites em Guarujá para empresas de turismo, comércio e serviços. Layout premium com SEO e foco em resultados.",
